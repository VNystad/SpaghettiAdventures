...
void Animation::init()
{
	...
	********************************** */
	...
	if (!PlayerTextureWalk.loadFromFile("data/Character-Animation/spaghetti.png"))
	std::cout << "Failed to load data/Character-Animation/spaghetti.png" << std::endl << std::endl;
	if (!PlayerTextureWalkflipped.loadFromFile("data/Character-Animation/spaghetti.png"))
	std::cout << "Failed to load data/Character-Animation/spaghetti.png" << std::endl << std::endl;
	if (!PlayerTextureIdle.loadFromFile("data/Character-Animation/spaghetti.png"))
	std::cout << "Failed to load data/Character-Animation/spaghetti.png" << std::endl << std::endl;
	if (!PlayerTextureIdleFlipped.loadFromFile("data/Character-Animation/spaghetti.png"))
	std::cout << "Failed to load data/Character-Animation/spaghetti.png" << std::endl << std::endl;
	if (!PlayerTextureJump.loadFromFile("data/Character-Animation/spaghetti.png"))
	std::cout << "Failed to load data/Character-Animation/spaghetti.png" << std::endl << std::endl;
	if (!PlayerTextureJumpflipped.loadFromFile("data/Character-Animation/spaghetti.png"))
	std::cout << "Failed to load data/Character-Animation/spaghetti.png" << std::endl << std::endl;
	if (!PlayerTextureDeath.loadFromFile("data/Character-Animation/spaghetti.png"))
	std::cout << "Failed to load data/Character-Animation/spaghetti.png" << std::endl << std::endl;
	if (!PlayerTextureAttack.loadFromFile("data/Character-Animation/spaghetti.png"))
	std::cout << "Failed to load data/Character-Animation/spaghetti.png" << std::endl << std::endl;
